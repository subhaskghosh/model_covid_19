...
\begin{figure*}[t!]
	...
	\begin{subfigure}[t]{0.5\textwidth}
		\centering
		\includegraphics[width=\textwidth]{India_plot_model_data.pdf}
	\end{subfigure}
...
\begin{figure*}[t!]
	\centering
		...
		\centering
		\includegraphics[width=1\linewidth]{Italy_evolution.pdf}
	\end{subfigure}
\begin{subfigure}[b]{0.8\textwidth}
	\centering
...
%
\begin{equation}
\mathcal{R}_0 = \rho \beta \left( \frac{\alpha \theta}{r_1 r_2} + \frac{\left( 1-\alpha\right) \epsilon \varphi}{r_2 r_3 r_4} + \frac{\left( 1-\alpha\right) \gamma \theta}{r_1 r_2 r_3}\right) + \kappa \beta \left( \frac{1-\alpha}{r_3} \right) - \beta \left( \frac{\alpha}{r_1} + \frac{\gamma \left(1-\alpha \right) }{r_1 r_3}\right)  - \omega \beta \left( \frac{\epsilon \left( 1-\alpha\right) }{r_3 r_4}\right) 
\label{eqn:Rnot}
\end{equation}
%
%
...
\subsubsection{Scenario: Contagious strain }

\subsubsection{Scenario: Reinfection and loss of Immunity }
