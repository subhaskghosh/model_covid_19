...
import lmfit
import argparse
from src.plots import plot_compare_brazil, plot_evolution_Brazil
...
parser.add_argument('--gamma', type=float, default=0.0372, help='recovery rate of asymptomatic')
parser.add_argument('--eta', type=float, default=0.0441, help='recovery rate of symptomatic')
parser.add_argument('--mu', type=float, default=0.0372, help='recovery rate of quarantined')
parser.add_argument('--psi', type=float, default=0.0511, help='recovery rate of isolated')
parser.add_argument('--zeta', type=float, default=0.0571, help='recovery rate of critical')
parser.add_argument('--delta', type=float, default=0.0102, help='mortality rate')
...
# plt.show()
t, E, I, A, Q, H, C, D, R, S, DR, TI, beta_over_time, epsilon_over_time = Model(500,
