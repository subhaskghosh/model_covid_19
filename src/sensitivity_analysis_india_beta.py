...
import lmfit
import argparse
from src.plots import plot_sensitivity_beta_india
...
t, E, I, A, Q, H, C, D, R, S, DR, TI, beta_over_time, epsilon_over_time = Model(700,
                                                                                ...
                                                                                best_values['s'],
                                                                                best_values['epsilon_max'],
                                                                                best_values['et_0'],0.9)
[TI5, DR5, R5, D5, CI5, CR5] = [TI, DR, R, D, (I + A + Q + H + C + R), C]


plot_sensitivity_beta_india(t,
