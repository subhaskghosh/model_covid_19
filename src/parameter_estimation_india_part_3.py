...
def Model(days, beta_0, t_0, beta_min, r, epsilon_0, s, epsilon_max, et_0):
    ...
    E_0 = 7.337761512838071e-05
    I_0 = 1.3664238844201173e-05
    A_0 = 1.5903384020536128e-05
    Q_0 = 6.36176335683191e-05
    H_0 = 0.00023951692729279667
    C_0 = 0.0001297384147478976
    D_0 = 0.00
    R_0 = 0.00
...
# Save plot data
x_mod_data = [(a+516) for a in x_data]
data = {'x_data': x_mod_data,
        'y_data': y_data,
        'best_fit': result.best_fit,
        'dely': dely}
confidence_plot_df = pd.DataFrame(data)
confidence_plot_df.to_csv(f'../data/india_confidence_plot_3.csv', index=False)
#
...
plot_compare_df.to_csv(f'../data/india_plot_compare_3.csv', index=False)
