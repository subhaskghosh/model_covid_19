...
import lmfit
import argparse
from src.plots import plot_scenario_vaccination_india
...
def Model(days, beta_0, t_0, beta_min, r, epsilon_0, s, epsilon_max, et_0, phi, xi_0, xi_max, vt_0, v):
    ...
    ret = odeint(deriv, y0, t, args=(beta, kappa, omega, rho, sigma, alpha, nu, epsilon, varphi, theta, tau, lamda, gamma, eta, mu, psi, zeta, delta, phi, xi))
...
xi_max_set = [0.3, 0.4, 0.5, 0.6, 0.7]

for xi_max in xi_max_set:
    simulation_values = {"phi":phi_set[0], "xi_0":0.0, "xi_max":xi_max, "vt_0":198+90, "v":0.011}
    ...
    simulation_values = {"phi":phi_set[1], "xi_0":0.0, "xi_max":xi_max, "vt_0":198+90, "v":0.011}
    ...
    simulation_values = {"phi":phi_set[2], "xi_0":0.0, "xi_max":xi_max, "vt_0":198+90, "v":0.011}
    t, E, I, A, Q, H, C, D, R, S, DR, TI, beta_over_time, epsilon_over_time, xi_over_time, V = Model(700,
                                                                                    best_values['beta_0'],
                                                                                    best_values['t_0'],
                                                                                    best_values['beta_min'],
    ...
    simulation_values = {"phi":phi_set[3], "xi_0":0.0, "xi_max":xi_max, "vt_0":198+90, "v":0.011}
    t, E, I, A, Q, H, C, D, R, S, DR, TI, beta_over_time, epsilon_over_time, xi_over_time, V = Model(700,
                                                                                    best_values['beta_0'],
                                                                                    best_values['t_0'],
                                                                                    best_values['beta_min'],
    ...
    simulation_values = {"phi":phi_set[4], "xi_0":0.0, "xi_max":xi_max, "vt_0":198+90, "v":0.011}
    t, E, I, A, Q, H, C, D, R, S, DR, TI, beta_over_time, epsilon_over_time, xi_over_time, V = Model(700,
                                                                                    best_values['beta_0'],
                                                                                    best_values['t_0'],
                                                                                    best_values['beta_min'],
    ...
    plot_scenario_vaccination_india(t,
