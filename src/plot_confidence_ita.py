...
#Load
df_1 = pd.read_csv(f'../data/italy_confidence_plot_1.csv')
df_2 = pd.read_csv(f'../data/italy_confidence_plot_2.csv')
df_3 = pd.read_csv(f'../data/italy_confidence_plot_3.csv')
df_4 = pd.read_csv(f'../data/italy_confidence_plot_4.csv')
df_5 = pd.read_csv(f'../data/italy_confidence_plot_5.csv')
confidence_plot_df = pd.concat([df_1, df_2, df_3, df_4, df_5])
