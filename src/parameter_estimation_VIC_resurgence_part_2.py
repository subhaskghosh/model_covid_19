...
parser.add_argument('--delta', type=float, default=0.034, help='mortality rate')
...
params_init_min_max = {"beta_0": (0.8, 0.5, 1.8),
...
x_mod_data = [(a+448) for a in x_data]
data = {'x_data': x_mod_data,
        'y_data': y_data,
        'best_fit': result.best_fit,
        'dely': dely}
confidence_plot_df = pd.DataFrame(data)
# confidence_plot_df.to_csv(f'../data/victoria_confidence_plot_2.csv', index=False)
...
plot_compare_df.to_csv(f'../data/victoria_plot_compare_2.csv', index=False)
