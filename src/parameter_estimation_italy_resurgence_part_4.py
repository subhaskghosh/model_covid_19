...
parser.add_argument('--theta', type=float, default=0.179, help='rate of detection of symptomatic')
...
parser.add_argument('--delta', type=float, default=0.098, help='mortality rate')
...
def Model(days, beta_0, t_0, beta_min, r, epsilon_0, s, epsilon_max, et_0, beta_new, u, t_1, beta_min_1, t_2, v):
    ...
    E_0 = 9000.0 / population
    I_0 = 10000.0 / population
    A_0 = 3000.0 / population
    Q_0 = 1001.0 / population
    H_0 = 2000.0 / population
    C_0 = 300.0 / population
    D_0 = 700.0 / population
    R_0 = 100.0 / population
...
# Save plot data
x_mod_data = [(a+490) for a in x_data]
data = {'x_data': x_mod_data,
        'y_data': y_data,
        'best_fit': result.best_fit,
        'dely': dely}
confidence_plot_df = pd.DataFrame(data)
#confidence_plot_df.to_csv(f'../data/italy_confidence_plot_4.csv', index=False)
#
#
...
plot_compare_df.to_csv(f'../data/italy_plot_compare_4.csv', index=False)
