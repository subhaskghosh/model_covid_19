...
def Model(days, beta_0, t_0, beta_min, r, epsilon_0, s, epsilon_max, et_0, beta_new, u, t_1, chi_val):
    # Contact
    def beta(t):
        if t < t_0:
            return beta_0
    ...
    beta, kappa, omega, rho, sigma, alpha, nu, epsilon, varphi, theta, tau, lamda, gamma, eta, mu, psi, zeta, delta,
    chi))
...
t, E, I, A, Q, H, C, D, R, S, DR, TI, beta_over_time, epsilon_over_time, TR = Model(3650,
                                                                                best_values['beta_0'],
                                                                                best_values['t_0'],
...
plot_scenario_reinfection_italy(t,
