...
#Load
df_1 = pd.read_csv(f'../data/victoria_confidence_plot_1.csv')
df_2 = pd.read_csv(f'../data/victoria_confidence_plot_2.csv')
df_3 = pd.read_csv(f'../data/victoria_confidence_plot_3.csv')
...
plt.ylim(0, 2.5e-2)
#plt.show()
plt.savefig(f'../doc/Victoria_model_confidence.pdf', dpi=600)
plt.clf()
