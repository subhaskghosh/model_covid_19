...
import lmfit
import argparse
from src.plots import plot_evolution_vic, plot_compare_india

#Load
df_1 = pd.read_csv(f'../data/india_plot_compare_1.csv')
df_2 = pd.read_csv(f'../data/india_plot_compare_2.csv')
df_3 = pd.read_csv(f'../data/india_plot_compare_3.csv')
