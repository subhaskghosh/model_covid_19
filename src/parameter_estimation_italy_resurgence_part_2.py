...
parser.add_argument('--tau', type=float, default=0.0006, help='rate of developing life-threatening symptoms in isolation')
parser.add_argument('--lamda', type=float, default=0.006, help='rate of developing life-threatening symptoms for symptomatic')
...
# Save plot data
x_mod_data = [(a+170) for a in x_data]
data = {'x_data': x_mod_data,
        'y_data': y_data,
        'best_fit': result.best_fit,
        'dely': dely}
confidence_plot_df = pd.DataFrame(data)
#confidence_plot_df.to_csv(f'../data/italy_confidence_plot_2.csv', index=False)
#
#
...
plot_compare_df.to_csv(f'../data/italy_plot_compare_2.csv', index=False)
